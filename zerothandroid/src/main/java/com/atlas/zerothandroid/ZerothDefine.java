...
public class ZerothDefine {
    ...
    public static final String OPT_16_KHZ_MONO = "audio/x-raw,+layout=(string)interleaved,+rate=(int)16000,+format=(string)S16LE,+channels=(int)1";
    public static final String OPT_44_KHZ_MONO = "audio/x-raw,+layout=(string)interleaved,+rate=(int)44100,+format=(string)S16LE,+channels=(int)1";
